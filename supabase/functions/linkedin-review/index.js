    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are a LinkedIn recruiter giving profile improvement suggestions."
          },
          {
            role: "user",
            content: `Analyze this LinkedIn profile and provide detailed suggestions: ${linkedinURL}`
          }
        ],
        max_tokens: 800
      })
